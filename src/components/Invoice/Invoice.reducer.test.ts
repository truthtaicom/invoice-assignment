...
describe('reducer', () => {
  ...
  it('should create an reducer to edit invoice', () => {
    ...
    const result = invoiceReducer(undefined, { type: types.EDIT_INVOICE, payload: { currentItem: { id: 1 },  changedItem: { id: 1 } } })
    expect(result).toEqual(expected)
  })
  it('should create an reducer to delete invoice', () => {
    ...
    const result = invoiceReducer(undefined, { type: types.DELETE_INVOICE, payload: 1 })
    expect(result).toEqual(expected)
  })
  it('should create an reducer to search IBAN with request status', () => {
    ...
    const result = invoiceReducer(undefined, { type: types.SEARCH_IBAN_REQUEST, payload: 'a' })
    expect(result).toEqual(expected)
  })
